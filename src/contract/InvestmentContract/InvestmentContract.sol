...
contract InvestmentContract is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(contractBalance >= totalPendingWithdrawals + amount, "Insufficient balance after reserving pending withdrawals");
    ...
    function withdrawShare(uint256 index) public whenNotPaused nonReentrant {
        ...
        if (deposits[msg.sender] == 0 && withdrawalRequests[msg.sender].length == 1) {
    ...
    function getPendingWithdrawalTotal() public view returns (uint256) { return totalPendingWithdrawals; }
